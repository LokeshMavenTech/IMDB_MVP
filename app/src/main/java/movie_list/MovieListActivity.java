...
import static utils.Constants.ACTION_MOVIE_FILTER;
import static utils.Constants.KEY_MOVIE_ID;
import static utils.Constants.KEY_RELEASE_FROM;
import static utils.Constants.KEY_RELEASE_TO;
import static utils.GridSpacingItemDecoration.dpToPx;
...
import model.Movie;
import movie_details.MovieDetailsActivity;
import movie_filter.MovieFilterActivity;
...
public class MovieListActivity extends AppCompatActivity implements MovieListContract.View, MovieItemClickListener,ShowEmptyView {
    ...
    BottomNavigationItemView bottomNavigationItemViewHome;
    BottomNavigationItemView bottomNavigationItemViewPop;
    BottomNavigationItemView bottomNavigationItemViewSearch;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        bottomNavigationItemViewHome =findViewById(R.id.navigation_home);
        bottomNavigationItemViewHome.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        bottomNavigationItemViewPop=findViewById(R.id.navigation_popular);
        bottomNavigationItemViewPop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                movieListPresenter.getTopRatedDataFromServer();
    ...
    private void initUI() {
        ...
        moviesAdapter = new MoviesAdapter(this, moviesList,false);
